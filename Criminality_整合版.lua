...
-- =========================================================
-- Criminality新.lua feature migration layer
-- Old UI / initialization / key system are kept from Criminality.lua.
-- New authentication, validation, UI and bootstrap are intentionally excluded.
-- =========================================================
