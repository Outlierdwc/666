...
local Window = WindUI:CreateWindow({
    Title = redWhiteGradient("Tnine Hub｜"..gamename),
    IconThemed = true,
    Folder = "tnine",
    ...
    HideSearchBar = true,
    Background = "https://chaton-images.s3.us-east-2.amazonaws.com/JyLgYJbYNUHZUf9lHhLNa0d1jpMpv7uXGyBetPv0eEAZeiCz0HrUudEfPW4vJrLr_2732x1534x3398182.png",
...
do
    ...
    Tabs.Legitbot = Window:Tab({ Title = "合法自瞄", })
    Tabs.Ragebot = Window:Tab({ Title = "暴力自瞄", })
    Tabs.Misc = Window:Tab({ Title = "其他功能", })
    Tabs.GodMode = Window:Tab({ Title = "无敌功能", })
end
...
Tabs.Legitbot:Toggle({
    Title = "启用合法自瞄",
    Desc = "开启合法自瞄功能",
    Value = LegitAimbotModule.Enabled,
    Callback = function(Value)
        LegitAimbotModule.Enabled = Value
    end
})
...
Tabs.Legitbot:Toggle({
    Title = "可见性检查",
    Desc = "只瞄准可见的敌人",
    Value = LegitAimbotModule.Settings.VisibleCheck,
    Callback = function(Value)
        LegitAimbotModule.Settings.VisibleCheck = Value
    end
})
...
Tabs.Legitbot:Toggle({
    Title = "力场检查",
    Desc = "跳过后面有力场的玩家",
    Value = LegitAimbotModule.Settings.ForcefieldCheck,
    Callback = function(Value)
        LegitAimbotModule.Settings.ForcefieldCheck = Value
    end
})
...
Tabs.Legitbot:Toggle({
    Title = "倒地检查",
    Desc = "跳过倒地的玩家",
    Value = LegitAimbotModule.Settings.DownedCheck,
    Callback = function(Value)
        LegitAimbotModule.Settings.DownedCheck = Value
    end
})
...
Tabs.Legitbot:Toggle({
    Title = "死亡检查",
    Desc = "跳过死亡的玩家",
    Value = LegitAimbotModule.Settings.DiedCheck,
    Callback = function(Value)
        LegitAimbotModule.Settings.DiedCheck = Value
    end
})
...
Tabs.Legitbot:Toggle({
    Title = "队伍检查",
    Desc = "不瞄准队友",
    Value = LegitAimbotModule.Settings.TeamCheck,
    Callback = function(Value)
        LegitAimbotModule.Settings.TeamCheck = Value
    end
})
...
Tabs.Legitbot:Toggle({
    Title = "使用按键绑定",
    Desc = "需要按住按键才能瞄准",
    Value = LegitAimbotModule.Settings.UseKeybind,
    Callback = function(Value)
        LegitAimbotModule.Settings.UseKeybind = Value
    end
})

Tabs.Legitbot:Slider({
    Title = "视野范围",
    Desc = "自瞄的FOV范围",
    Value = {
        Min = 0,
        Max = 360,
        Default = LegitAimbotModule.Settings.FOV,
    },
    Callback = function(Value)
        LegitAimbotModule.Settings.FOV = Value
    end
})
...
Tabs.Legitbot:Slider({
    ...
    Value = {
        Min = 0,
        Max = 100,
        Default = LegitAimbotModule.Settings.Smoothness,
    },
    Callback = function(Value)
        LegitAimbotModule.Settings.Smoothness = Value
    end
})
...
Tabs.Legitbot:Toggle({
    Title = "手臂特效",
    Desc = "手臂材质特效",
    Value = LegitAimbotModule.ArmChams.Enabled,
    Callback = function(Value)
        LegitAimbotModule.ArmChams.Enabled = Value
    end
})
...
Tabs.Legitbot:Slider({
    ...
    Value = {
        Min = 0,
        Max = 1,
        Default = LegitAimbotModule.ArmChams.TransparencyValue,
    },
    Callback = function(Value)
        LegitAimbotModule.ArmChams.TransparencyValue = Value
    end
})
...
Tabs.Legitbot:Toggle({
    Title = "物品特效",
    Desc = "物品材质特效",
    Value = LegitAimbotModule.ItemsChams.Enabled,
    Callback = function(Value)
        LegitAimbotModule.ItemsChams.Enabled = Value
    end
})
...
Tabs.Legitbot:Slider({
    ...
    Value = {
        Min = 0,
        Max = 1,
        Default = LegitAimbotModule.ItemsChams.TransparencyValue,
    },
    Callback = function(Value)
        LegitAimbotModule.ItemsChams.TransparencyValue = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "启用ESP",
    Desc = "显示玩家ESP",
    Value = VisualModule.ESP.Enabled,
    Callback = function(Value)
        VisualModule.ESP.Enabled = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "方框ESP",
    Desc = "显示玩家方框",
    Value = VisualModule.ESP.Box,
    Callback = function(Value)
        VisualModule.ESP.Box = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "名字ESP",
    Desc = "显示玩家名字",
    Value = VisualModule.ESP.Name,
    Callback = function(Value)
        VisualModule.ESP.Name = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "距离ESP",
    Desc = "显示玩家距离",
    Value = VisualModule.ESP.Distance,
    Callback = function(Value)
        VisualModule.ESP.Distance = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "血量ESP",
    Desc = "显示玩家血量",
    Value = VisualModule.ESP.Health,
    Callback = function(Value)
        VisualModule.ESP.Health = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "武器ESP",
    Desc = "显示玩家武器",
    Value = VisualModule.ESP.Tool,
    Callback = function(Value)
        VisualModule.ESP.Tool = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "队伍颜色",
    Desc = "根据队伍显示颜色",
    Value = VisualModule.ESP.TeamColor,
    Callback = function(Value)
        VisualModule.ESP.TeamColor = Value
    end
})
...
Tabs.Visual:Slider({
    ...
    Value = {
        Min = 0,
        Max = 1000,
        Default = VisualModule.ESP.MaxDistance,
    },
    Callback = function(Value)
        VisualModule.ESP.MaxDistance = Value
    end
})
...
Tabs.Visual:Slider({
    ...
    Value = {
        Min = 10,
        Max = 20,
        Default = VisualModule.ESP.TextSize,
    },
    Callback = function(Value)
        VisualModule.ESP.TextSize = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "启用子弹轨迹",
    Desc = "显示子弹飞行轨迹",
    Value = BulletTracersModule.Enabled,
    Callback = function(Value)
        BulletTracersModule.Enabled = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "显示轨迹",
    Desc = "显示子弹轨迹",
    Value = BulletTracersModule.Settings.Enabled,
    Callback = function(Value)
        BulletTracersModule.Settings.Enabled = Value
    end
})
...
Tabs.Visual:Slider({
    ...
    Value = {
        Min = 0.1,
        Max = 5,
        Default = BulletTracersModule.Settings.Lifetime,
    },
    Callback = function(Value)
        BulletTracersModule.Settings.Lifetime = Value
    end
})
...
Tabs.Visual:Slider({
    ...
    Value = {
        Min = 0.01,
        Max = 1,
        Default = BulletTracersModule.Settings.Width,
    },
    Callback = function(Value)
        BulletTracersModule.Settings.Width = Value
    end
})
...
Tabs.Visual:Toggle({
    Title = "角色渲染",
    Desc = "改变角色材质",
    Value = CharacterRenderModule.Enabled,
    Callback = function(Value)
        CharacterRenderModule.Enabled = Value
...
Tabs.Visual:Slider({
    ...
    Value = {
        Min = 0,
        Max = 1,
        Default = CharacterRenderModule.Transparency,
    },
    Callback = function(Value)
        CharacterRenderModule.Transparency = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "启用ragebot",
    Desc = "rage",
    Value = ConfigTable.Ragebot.Enabled,
    Callback = function(Value)
        ConfigTable.Ragebot.Enabled = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "Fire Speed",
    Desc = "射击速度",
    Value = ConfigTable.Ragebot.RapidFire,
    Callback = function(Value)
        ConfigTable.Ragebot.RapidFire = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "自动换弹",
    Desc = "自动装填弹药",
    Value = ConfigTable.Ragebot.AutoReload,
    Callback = function(Value)
        ConfigTable.Ragebot.AutoReload = Value
        autoReload()
    end
})
...
Tabs.Ragebot:Slider({
    ...
    Value = {
        Min = 1,
        Max = 1000,
        Default = ConfigTable.Ragebot.FireRate,
    },
    Callback = function(Value)
        ConfigTable.Ragebot.FireRate = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "预判",
    Desc = "预判目标移动",
    Value = ConfigTable.Ragebot.Prediction,
    Callback = function(Value)
        ConfigTable.Ragebot.Prediction = Value
    end
})
...
Tabs.Ragebot:Slider({
    ...
    Value = {
        Min = 0.05,
        Max = 0.3,
        Default = ConfigTable.Ragebot.PredictionAmount,
    },
    Callback = function(Value)
        ConfigTable.Ragebot.PredictionAmount = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "穿墙",
    Desc = "wallbang",
    Value = ConfigTable.Ragebot.Wallbang,
    Callback = function(Value)
        ConfigTable.Ragebot.Wallbang = Value
    end
})
...
Tabs.Ragebot:Slider({
    ...
    Value = {
        Min = 1,
        Max = 30,
        Default = ConfigTable.Ragebot.ShootRange,
    },
    Callback = function(Value)
        ConfigTable.Ragebot.ShootRange = Value
    end
})
...
Tabs.Ragebot:Slider({
    ...
    Value = {
        Min = 1,
        Max = 30,
        Default = ConfigTable.Ragebot.HitRange,
    },
    Callback = function(Value)
        ConfigTable.Ragebot.HitRange = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "队伍检查",
    Desc = "不攻击队友",
    Value = ConfigTable.Ragebot.TeamCheck,
    Callback = function(Value)
        ConfigTable.Ragebot.TeamCheck = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "可见性检查",
    Desc = "只攻击可见目标",
    Value = ConfigTable.Ragebot.VisibilityCheck,
    Callback = function(Value)
        ConfigTable.Ragebot.VisibilityCheck = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "好友检查",
    Desc = "不攻击好友",
    Value = ConfigTable.Ragebot.FriendCheck,
    Callback = function(Value)
        ConfigTable.Ragebot.FriendCheck = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "低血量检查",
    Desc = "不攻击低血玩家",
    Value = ConfigTable.Ragebot.LowHealthCheck,
    Callback = function(Value)
        ConfigTable.Ragebot.LowHealthCheck = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "使用目标列表",
    Desc = "只攻击目标列表中的玩家",
    Value = ConfigTable.Ragebot.UseTargetList,
    Callback = function(Value)
        ConfigTable.Ragebot.UseTargetList = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "使用白名单",
    Desc = "不攻击白名单中的玩家",
    Value = ConfigTable.Ragebot.UseWhitelist,
    Callback = function(Value)
        ConfigTable.Ragebot.UseWhitelist = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "显示轨迹",
    Desc = "显示子弹轨迹",
    Value = ConfigTable.Ragebot.Tracers,
    Callback = function(Value)
        ConfigTable.Ragebot.Tracers = Value
    end
})
...
Tabs.Ragebot:Slider({
    ...
    Value = {
        Min = 0.1,
        Max = 5,
        Default = ConfigTable.Ragebot.TracerWidth,
    },
    Callback = function(Value)
        ConfigTable.Ragebot.TracerWidth = Value
    end
})
...
Tabs.Ragebot:Slider({
    ...
    Value = {
        Min = 0.5,
        Max = 10,
        Default = ConfigTable.Ragebot.TracerLifetime,
    },
    Callback = function(Value)
        ConfigTable.Ragebot.TracerLifetime = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "命中通知",
    Desc = "显示命中通知",
    Value = ConfigTable.Ragebot.HitNotify,
    Callback = function(Value)
        ConfigTable.Ragebot.HitNotify = Value
    end
})
...
Tabs.Ragebot:Slider({
    ...
    Value = {
        Min = 1,
        Max = 10,
        Default = ConfigTable.Ragebot.HitNotifyDuration,
    },
    Callback = function(Value)
        ConfigTable.Ragebot.HitNotifyDuration = Value
    end
})
...
Tabs.Ragebot:Toggle({
    Title = "命中音效",
    Desc = "播放命中音效",
    Value = ConfigTable.Ragebot.HitSound,
    Callback = function(Value)
        ConfigTable.Ragebot.HitSound = Value
    end
})
...
Tabs.Misc:Toggle({
    Title = "时间",
    Desc = "设置游戏时间",
    Value = forceTimeEnabled,
    Callback = function(Value)
        forceTimeEnabled = Value
        if Value then enableForceTime() else disableForceTime() end
    end
})
