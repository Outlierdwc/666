...
local UiParent = PlayerGui  -- 修改：直接使用 PlayerGui
...
local function bootstrap()
    ...
    deferTask(function()
        ...
        if not ok then
            warn("[JX Farm] UI creation failed:", err)
            pcall(function()
                game:GetService("StarterGui"):SetCore("SendNotification", {
                    Title = "JX Farm Error",
                    Text = "UI creation failed, check console",
                    Duration = 5
                })
            end)
        else
            print("JX Farm UI created successfully")
            pcall(function()
                game:GetService("StarterGui"):SetCore("SendNotification", {
                    Title = "JX Farm",
                    Text = "UI Loaded",
...
if not bootstrapOk then
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "JX Farm Error",
            Text = "Bootstrap failed: " .. tostring(bootstrapError),
            Duration = 10
        })
    end)
end