...
local API_BASE = "" -- disabled for local testing
local expirationHours = nil
local keyless = false
local VERIFY_PATH = ""
local PUBLIC_CONFIG_PATH = ""
local WEBHOOK_PROXY_URL = ""
local AUTH_TOKEN_URL = ""
...
local API_KEY = nil -- removed key system for private testing
...
local function bootstrap()
    ...
    print("[JX DEBUG] Local test mode loaded - key system disabled")\n    print("JX-CRIMINALITY-FARM FULLY LOADED")
    return true
end
