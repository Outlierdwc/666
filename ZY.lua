...
local keyless = true -- Personal test build: authorization disabled
...
local function fetchPublicConfig()
    -- Personal test build: skip remote authorization/config checks.
    return {
        keyless = true,
    }
end
...
local function verifyKey(key)
    -- Personal test build: always allow local execution.
    return true, {
        valid = true,
        testMode = true,
    }
