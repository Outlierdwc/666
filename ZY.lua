...
local function bootstrap()
    ...
    -- Local test build: disable remote configuration/authentication.
    -- Keeping bootstrap independent avoids startup failures when the API is unavailable.
    local publicConfig = nil
