--[[
 Criminality Unified Refactor (Owner Source)
 Phase 1:
 - Combined server and farm logic
 - Centralized common Roblox services
 - Removed duplicate service declarations
 - Prepared for modular cleanup

 Note: review external integrations before production use.
]]
