--[[ 
JX Criminality Combined Script
Merged from:
- Criminality Server.lua
- Criminality Farm.lua

Merge method:
- Original code bodies preserved
- No resource paths/config values intentionally changed
- Server initialization kept before Farm initialization
]]
